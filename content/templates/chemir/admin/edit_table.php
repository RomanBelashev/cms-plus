...
<center>
    ...
    <div id='logo'> <a href="index.html"><img src="http://<?php echo DOMAIN;?>/content/templates/chemir/img/realter_2.png" alt="Риэлтер" width="260" height="100"/></a>   </div>
    <div id='txt'> </div>
    ...
    <form method="post" id="art" name="art">
        ...
        " <?php echo $check_students; ?>/></p></td>
            ...
            <td colspan='18' class='title'><textarea  name='text' cols='120' rows='4'><?php echo $res['text']; ?></textarea></td></tr>          
